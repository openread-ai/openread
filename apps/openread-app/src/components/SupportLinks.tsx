...
const SupportLinks = () => {
  ...
  return (
    <div className='my-2 flex flex-col items-center gap-2'>
      <p className='text-neutral-content text-sm'>{_('Get Help from the Openread Community')}</p>
      <div className='flex gap-4'>
        <Link
          href='https://github.com/openread/openread'
        ...
        <Link
          href='https://reddit.com/r/openread/'
