...
export const LOCAL_PERSISTENCE_KEYS = {
  ...
  sampleBookAttempted: 'sample_book_attempted',
...
export const LOCAL_PERSISTENCE_REGISTRY = [
  ...
  {
    key: LOCAL_PERSISTENCE_KEYS.hasSeenWelcome,
    storage: 'localStorage',
    owner: 'hooks/useWelcomeScreen and ActivityCaptureBridge',
    scope: 'setting-local-only',
    description: 'Local onboarding/welcome dismissed sentinel.',
  },
  {
    key: LOCAL_PERSISTENCE_KEYS.sampleBookAttempted,
    storage: 'localStorage',
    owner: 'lib/sample-book and hooks/useSampleBook',
    scope: 'derived',
    description: 'Local sentinel preventing repeated sample-book import attempts.',
    deletionCriteria: 'May be cleared to allow sample-book import retry during reset/debug.',
  },
  {
